...
set_clock_uncertainty 0.2800 wb_clk_i
...
set_clock_uncertainty 0.2800 user_clock
...
set_clock_uncertainty 0.2800 sck
set_propagated_clock [get_clocks {sck}]
create_generated_clock -name wbbd_sck -source [get_ports {wb_clk_i}] -divide_by 2 [get_pins {_7203_/Q}]
set_clock_uncertainty 0.2800 wbbd_sck
...
# Design Rules
###############################################################################
set_max_transition 0.7400 [current_design]
