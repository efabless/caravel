...
## MASTER CLOCKS
create_clock -name clk -period 25 [get_pins {_20703_/X}] 
...
set_clock_uncertainty 1 [get_clocks {debug_clk}] 
...
set_input_delay -8 -clock [get_clocks {debug_clk}] [get_ports {mprj_io_in[0]}]

set_output_delay $output_delay_value  -clock [get_clocks {clk}] -add_delay [all_outputs]
set_output_delay 21 -clock [get_clocks {debug_clk}] [get_ports {mprj_io_out[0]}]
